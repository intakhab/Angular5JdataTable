...
public class AppUtil {
	...
	/*public static String buildPaginatedQuery(String baseQuery, PaginationCriteria paginationCriteria) {
		StringBuilder sb = new StringBuilder(
				"SELECT * FROM (SELECT * FROM ( #BASE_QUERY# ) "
				+ "#WHERE_CLAUSE#  "
				+ "#ORDER_CLASUE# ) LIMIT "
				+ "#PAGE_NUMBER#, "
				+ "#PAGE_SIZE#");
	...
	public static String buildPaginatedQuery(String baseQuery, PaginationCriteria paginationCriteria) {
		StringBuilder sb = new StringBuilder(
				"SELECT FILTERED_ORDERD_RESULTS.* FROM (SELECT BASEINFO.* FROM ( #BASE_QUERY# ) BASEINFO "
				+ "#WHERE_CLAUSE#  "
				+ "#ORDER_CLASUE# ) FILTERED_ORDERD_RESULTS LIMIT "
				+ "#PAGE_NUMBER#, "
				+ "#PAGE_SIZE#");
		String finalQuery = null;
		if(!AppUtil.isObjectEmpty(paginationCriteria)) {
